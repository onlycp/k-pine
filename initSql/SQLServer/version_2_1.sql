...
-- ----------------------------
CREATE TABLE  "sys_unit" (  "id" varchar(32)  NOT NULL ,  "name" varchar(50)  NOT NULL ,  "parent_id" varchar(32)  DEFAULT NULL ,  "path" text  NOT NULL ,  "leader" varchar(255)  DEFAULT NULL ,  "mobile" varchar(20)  DEFAULT NULL ,  "email" varchar(50)  DEFAULT NULL ,  "status" tinyint NOT NULL DEFAULT '1' ,  "note" text  ,  "order_num" int DEFAULT '0' ,  "who_created" varchar(32)  NOT NULL ,  "when_created" varchar(20)  NOT NULL ,  "who_modified" varchar(32)  NOT NULL ,  "when_modified" varchar(20)  NOT NULL ,  "app_id" varchar(36)  DEFAULT NULL ,  PRIMARY KEY ("id") )  ;
-- ----------------------------
-- Table structure for sys_user
-- ----------------------------
CREATE TABLE  "sys_user" (  "id" varchar(50)  NOT NULL ,  "username" varchar(50)  NOT NULL ,  "password" varchar(256)  DEFAULT NULL ,  "real_name" varchar(50)  NOT NULL ,  "mobile" varchar(20)  DEFAULT NULL ,  "email" varchar(50)  DEFAULT NULL ,  "sex" tinyint DEFAULT NULL ,  "sys_unit_id" varchar(32)  DEFAULT NULL ,  "post" varchar(50)  DEFAULT NULL ,  "status" tinyint DEFAULT '1' ,  "note" text  ,  "who_created" varchar(32)  DEFAULT NULL ,  "when_created" varchar(20)  DEFAULT NULL ,  "who_modified" varchar(32)  DEFAULT NULL ,  "when_modified" varchar(20)  DEFAULT NULL ,  "deleted" tinyint DEFAULT '0' ,  "avatar" varchar(255)  DEFAULT NULL,  "app_id" varchar(36)  DEFAULT NULL ,  PRIMARY KEY ("id") ,      CONSTRAINT "fk_sys_unit_id" FOREIGN KEY ("sys_unit_id") REFERENCES "sys_unit" ("id"))  ;
-- ----------------------------
-- Table structure for sys_role
-- ----------------------------
CREATE TABLE  "sys_role" (  "id" varchar(32)  NOT NULL ,  "name" varchar(50)  NOT NULL ,  "code" varchar(50)  NOT NULL ,  "note" text  ,  "status" tinyint DEFAULT NULL ,  "who_created" varchar(32)  NOT NULL ,  "when_created" varchar(20)  NOT NULL ,  "who_modified" varchar(32)  NOT NULL ,  "when_modified" varchar(20)  NOT NULL ,  "app_id" varchar(36)  DEFAULT NULL ,  PRIMARY KEY ("id") )  ;
-- ----------------------------
-- Table structure for sys_user_role
-- ----------------------------
CREATE TABLE  "sys_user_role" (  "id" varchar(36)  NOT NULL ,  "sys_user_id" varchar(50)  NOT NULL ,  "sys_role_id" varchar(32)  NOT NULL ,  "who_created" varchar(32)  NOT NULL ,  "when_created" varchar(20)  NOT NULL ,  "app_id" varchar(36)  DEFAULT NULL ,  PRIMARY KEY ("id") )  ;
-- ----------------------------
-- Table structure for dev_api
-- ----------------------------
CREATE TABLE  "dev_api" (  "id" varchar(32)  NOT NULL DEFAULT '' ,  "api_name" varchar(50)  DEFAULT NULL ,  "application_id" varchar(32)  DEFAULT NULL ,  "api_url" varchar(128)  DEFAULT NULL ,  "api_note" text  ,  "api_tags" varchar(128)  DEFAULT NULL ,  "api_method" varchar(32)  DEFAULT 'get' ,  "api_argv_type" int DEFAULT NULL ,  "api_req_argv" text  ,  "api_rsp_argv" text  ,  "api_result_handler" varchar(128)  DEFAULT NULL ,  "who_created" varchar(32)  DEFAULT NULL ,  "when_created" varchar(20)  DEFAULT NULL ,  "who_modified" varchar(32)  DEFAULT NULL ,  "when_modified" varchar(20)  DEFAULT NULL ,  "api_flow_id" varchar(50)  DEFAULT NULL ,  "api_code" varchar(50)  DEFAULT NULL ,  "call_type" int DEFAULT NULL ,  "app_id" varchar(36)  DEFAULT NULL ,  PRIMARY KEY ("id") ) ;
-- ----------------------------
-- Table structure for dev_api_copy1
-- ----------------------------
CREATE TABLE  "dev_api_copy1" (  "id" varchar(32)  NOT NULL DEFAULT '' ,  "api_name" varchar(50)  DEFAULT NULL ,  "application_id" varchar(32)  DEFAULT NULL ,  "api_url" varchar(128)  DEFAULT NULL ,  "api_note" text  ,  "api_tags" varchar(128)  DEFAULT NULL ,  "api_method" varchar(32)  DEFAULT 'get' ,  "api_argv_type" int DEFAULT NULL ,  "api_req_argv" text  ,  "api_rsp_argv" text  ,  "api_result_handler" varchar(128)  DEFAULT NULL ,  "who_created" varchar(32)  DEFAULT NULL ,  "when_created" varchar(20)  DEFAULT NULL ,  "who_modified" varchar(32)  DEFAULT NULL ,  "when_modified" varchar(20)  DEFAULT NULL ,  "api_flow_id" varchar(50)  DEFAULT NULL ,  "api_code" varchar(50)  DEFAULT NULL ,  "call_type" int DEFAULT NULL ,  "app_id" varchar(36)  DEFAULT NULL ,  PRIMARY KEY ("id") ) ;
-- ----------------------------
...
-- ----------------------------
CREATE TABLE  "dev_view_model" (  "id" varchar(36)  NOT NULL ,  "name" varchar(50)  DEFAULT NULL ,  "note" text  ,  "who_created" varchar(32)  DEFAULT NULL ,  "when_created" datetime ,  "who_modified" varchar(32)  DEFAULT NULL ,  "when_modified" datetime ,  "deleted" int DEFAULT '0' ,  "tag" varchar(100)  DEFAULT NULL ,  "app_id" varchar(36)  DEFAULT NULL ,  PRIMARY KEY ("id") )  ;
-- ----------------------------
-- Table structure for dev_view_model_field
-- ----------------------------
CREATE TABLE  "dev_view_model_field" (  "id" varchar(32)  NOT NULL ,  "view_model_id" varchar(32)  DEFAULT NULL ,  "field" varchar(50)  DEFAULT NULL ,  "label" varchar(50)  DEFAULT NULL ,  "type" varchar(20)  DEFAULT NULL ,  "format_type" varchar(20)  DEFAULT NULL ,  "format_pattern" varchar(50)  DEFAULT NULL ,  "default_text" varchar(50)  DEFAULT NULL ,  "who_created" varchar(32)  DEFAULT NULL ,  "when_created" datetime ,  "who_modified" varchar(32)  DEFAULT NULL ,  "when_modified" datetime ,  "hidden" int DEFAULT '0' ,  "order_num" int DEFAULT '0' ,  "app_id" varchar(36)  DEFAULT NULL ,  PRIMARY KEY ("id"))  ;
-- ----------------------------
-- Table structure for dev_view_model_flow
-- ----------------------------
CREATE TABLE  "dev_view_model_flow" (  "id" varchar(32)  NOT NULL,  "flow_id" varchar(36)  DEFAULT NULL ,  "view_model_id" varchar(32)  DEFAULT NULL ,  "who_created" varchar(32)  DEFAULT NULL ,  "when_created" datetime ,  "who_modified" varchar(32)  DEFAULT NULL ,  "when_modified" datetime ,  "app_id" varchar(36)  DEFAULT NULL ,  PRIMARY KEY ("id") )  ;
-- ----------------------------
-- Table structure for sys_api
-- ----------------------------
CREATE TABLE  "sys_api" (  "id" varchar(32)  NOT NULL DEFAULT '' ,  "api_name" varchar(50)  DEFAULT NULL ,  "api_url" varchar(128)  DEFAULT NULL ,  "api_note" text  ,  "api_tags" varchar(128)  DEFAULT NULL ,  "api_method" varchar(32)  DEFAULT 'get' ,  "api_argv_type" int DEFAULT NULL ,  "api_req_argv" text  ,  "api_rsp_argv" text  ,  "api_result_handler" varchar(128)  DEFAULT NULL ,  "who_created" varchar(32)  DEFAULT NULL ,  "when_created" varchar(20)  DEFAULT NULL ,  "who_modified" varchar(32)  DEFAULT NULL ,  "when_modified" varchar(20)  DEFAULT NULL ,  "api_flow_id" varchar(50)  DEFAULT NULL ,  "api_code" varchar(50)  DEFAULT NULL ,  "call_type" int DEFAULT NULL ,  "app_id" varchar(36)  DEFAULT NULL ,  PRIMARY KEY ("id") ) ;
-- ----------------------------
-- Table structure for sys_base
-- ----------------------------
CREATE TABLE  "sys_base" (  "id" varchar(32)  NOT NULL ,  "name" varchar(50)  DEFAULT NULL ,  "code" varchar(50)  DEFAULT NULL ,  "note" text  ,  "who_created" varchar(32)  DEFAULT NULL ,  "when_created" varchar(20)  DEFAULT NULL ,  "who_modified" varchar(32)  DEFAULT NULL ,  "when_modified" varchar(20)  DEFAULT NULL ,  "is_test" tinyint DEFAULT NULL,  "app_id" varchar(36)  DEFAULT NULL ,  PRIMARY KEY ("id") ) ;
-- ----------------------------
-- Table structure for sys_config
-- ----------------------------
CREATE TABLE  "sys_config" (  "id" varchar(36)  NOT NULL ,  "name" varchar(255)  DEFAULT NULL ,  "code" varchar(255)  DEFAULT NULL ,  "value" varchar(255)  DEFAULT NULL ,  "is_sys" tinyint DEFAULT NULL ,  "note" varchar(255)  DEFAULT NULL ,  "who_created" varchar(32)  DEFAULT NULL ,  "when_created" varchar(20)  DEFAULT NULL ,  "who_modified" varchar(32)  DEFAULT NULL ,  "when_modified" varchar(20)  DEFAULT NULL ,  "value_type" tinyint DEFAULT '0',  "app_id" varchar(36)  DEFAULT NULL ,  PRIMARY KEY ("id")) ;
-- ----------------------------
-- Table structure for sys_data_access
-- ----------------------------
CREATE TABLE  "sys_data_access" (  "id" varchar(50)  NOT NULL ,  "name" varchar(50)  DEFAULT NULL ,  "status" tinyint DEFAULT NULL ,  "note" text  ,  "who_created" varchar(32)  DEFAULT NULL ,  "when_created" varchar(20)  DEFAULT NULL ,  "who_modified" varchar(32)  DEFAULT NULL ,  "when_modified" varchar(20)  DEFAULT NULL ,  "app_id" varchar(36)  DEFAULT NULL ,  PRIMARY KEY ("id") )  ;
-- ----------------------------
-- Table structure for sys_data_resource
-- ----------------------------
CREATE TABLE  "sys_data_resource" (  "id" varchar(32)  NOT NULL ,  "name" varchar(50)  DEFAULT NULL ,  "table_name" varchar(50)  DEFAULT NULL ,  "label_field" varchar(50)  DEFAULT NULL ,  "value_field" varchar(50)  DEFAULT NULL ,  "query_sql" text  ,  "is_tree" tinyint DEFAULT NULL ,  "is_only_leaf" tinyint DEFAULT NULL ,  "status" tinyint DEFAULT NULL ,  "who_created" varchar(32)  DEFAULT NULL ,  "when_created" varchar(20)  DEFAULT NULL ,  "who_modified" varchar(32)  DEFAULT NULL ,  "when_modified" varchar(20)  DEFAULT NULL ,  "extra_sql" text  ,  "app_id" varchar(36)  DEFAULT NULL ,  PRIMARY KEY ("id") )  ;
-- ----------------------------
-- Table structure for sys_data_access_resource
-- ----------------------------
CREATE TABLE  "sys_data_access_resource" (  "id" varchar(32)  NOT NULL ,  "data_id" varchar(36)  DEFAULT NULL ,  "access_id" varchar(50)  DEFAULT NULL ,  "table_name" varchar(50)  DEFAULT NULL ,  "who_created" varchar(32)  DEFAULT NULL ,  "when_created" varchar(20)  DEFAULT NULL ,  "app_id" varchar(36)  DEFAULT NULL ,  PRIMARY KEY ("id") ,    CONSTRAINT "fk_resource_access" FOREIGN KEY ("access_id") REFERENCES "sys_data_access" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION)  ;
-- ----------------------------
-- Table structure for sys_data_access_user
-- ----------------------------
CREATE TABLE  "sys_data_access_user" (  "id" varchar(32)  NOT NULL ,  "sys_user_id" varchar(50)  DEFAULT NULL ,  "sys_data_access_id" varchar(50)  DEFAULT NULL ,  "who_created" varchar(32)  DEFAULT NULL ,  "when_created" varchar(20)  DEFAULT NULL ,  "app_id" varchar(36)  DEFAULT NULL ,  PRIMARY KEY ("id") ,      CONSTRAINT "fk_user_access_id" FOREIGN KEY ("sys_data_access_id") REFERENCES "sys_data_access" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION,  CONSTRAINT "fk_user_access" FOREIGN KEY ("sys_user_id") REFERENCES "sys_user" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION)  ;

-- ----------------------------
-- Table structure for sys_dict
-- ----------------------------
CREATE TABLE  "sys_dict" (  "id" varchar(32)  NOT NULL ,  "name" varchar(50)  DEFAULT NULL ,  "code" varchar(50)  DEFAULT NULL ,  "note" text  ,  "who_created" varchar(32)  DEFAULT NULL ,  "when_created" varchar(20)  DEFAULT NULL ,  "who_modified" varchar(32)  DEFAULT NULL ,  "when_modified" varchar(20)  DEFAULT NULL ,  "app_id" varchar(36)  DEFAULT NULL ,  PRIMARY KEY ("id") )  ;
-- ----------------------------
-- Table structure for sys_dict_item
-- ----------------------------
CREATE TABLE  "sys_dict_item" (  "id" varchar(32)  NOT NULL ,  "name" varchar(50)  DEFAULT NULL ,  "group_name" varchar(50)  DEFAULT NULL ,  "sys_dict_id" varchar(32)  DEFAULT NULL ,  "code" varchar(50)  DEFAULT NULL ,  "value" varchar(20)  DEFAULT NULL ,  "order_num" int DEFAULT NULL ,  "note" text  ,  "who_created" varchar(32)  DEFAULT NULL ,  "when_created" varchar(20)  DEFAULT NULL ,  "who_modified" varchar(32)  DEFAULT NULL ,  "when_modified" varchar(20)  DEFAULT NULL ,  "app_id" varchar(36)  DEFAULT NULL ,  PRIMARY KEY ("id") )  ;
-- ----------------------------
-- Table structure for sys_file
-- ----------------------------
CREATE TABLE  "sys_file" (  "id" varchar(32)  NOT NULL ,  "file_name" varchar(100)  DEFAULT NULL ,  "file_original_name" varchar(100)  DEFAULT NULL ,  "file_size" int DEFAULT NULL ,  "file_ext" text  ,  "file_md5" varchar(40)  DEFAULT NULL ,  "file_from" varchar(50)  DEFAULT NULL ,  "save_type" int DEFAULT NULL ,  "file_path" varchar(100)  DEFAULT NULL ,  "file_content" text  ,  "who_created" varchar(32)  DEFAULT NULL ,  "when_created" varchar(20)  DEFAULT NULL ,  "who_modified" varchar(32)  DEFAULT NULL ,  "when_modified" varchar(20)  DEFAULT NULL ,  "app_id" varchar(36)  DEFAULT NULL ,  PRIMARY KEY ("id") )  ;
-- ----------------------------
-- Table structure for sys_logic_flow
-- ----------------------------
CREATE TABLE  "sys_logic_flow" (  "id" varchar(36)  NOT NULL ,  "name" varchar(255)  DEFAULT NULL ,  "flow_id" varchar(36)  DEFAULT NULL ,  "application_id" varchar(32)  DEFAULT NULL ,  "tags" varchar(255)  DEFAULT NULL ,  "in_argv" text  ,  "out_argv" text  ,  "sub_flow_ids" text  ,  "note" varchar(255)  DEFAULT NULL ,  "who_created" varchar(32)  DEFAULT NULL ,  "when_created" datetime ,  "who_modified" varchar(32)  DEFAULT NULL ,  "when_modified" datetime ,  "app_id" varchar(36)  DEFAULT NULL ,  PRIMARY KEY ("id") )  ;
-- ----------------------------
-- Table structure for sys_login_log
-- ----------------------------
CREATE TABLE  "sys_login_log" (  "id" varchar(32)  NOT NULL ,  "operate_time" datetime ,  "operator" varchar(32)  DEFAULT NULL ,  "ip" varchar(20)  DEFAULT NULL ,  "times" int DEFAULT NULL ,  "response_code" int DEFAULT NULL ,  "response_message" varchar(100)  DEFAULT NULL ,  "when_created" varchar(20)  DEFAULT NULL ,  PRIMARY KEY ("id") )  ;
-- ----------------------------
-- Table structure for sys_menu
-- ----------------------------
CREATE TABLE  "sys_menu" (  "id" varchar(32)  NOT NULL ,  "name" varchar(50)  NOT NULL ,  "parent_id" varchar(32)  DEFAULT NULL ,  "icon" varchar(50)  DEFAULT NULL ,  "code" varchar(50)  DEFAULT NULL ,  "router_path" varchar(255)  DEFAULT NULL ,  "component_path" varchar(255)  DEFAULT NULL ,  "is_hidden" tinyint NOT NULL DEFAULT '0' ,  "menu_type" char(1)  NOT NULL DEFAULT '0' ,  "api_codes" varchar(255)  DEFAULT NULL ,  "open_mode" tinyint NOT NULL ,  "keep_alive" tinyint DEFAULT NULL ,  "path" text  NOT NULL ,  "order_num" int NOT NULL DEFAULT '0' ,  "status" tinyint NOT NULL DEFAULT '1' ,  "who_created" varchar(32)  NOT NULL ,  "when_created" varchar(20)  NOT NULL ,  "who_modified" varchar(32)  NOT NULL ,  "when_modified" varchar(20)  NOT NULL ,  "app_id" varchar(36)  DEFAULT NULL ,  "data_type" tinyint DEFAULT NULL ,  "theme" varchar(50)  DEFAULT NULL ,  "page_type" tinyint DEFAULT NULL ,  "sidebar_nav_mode" tinyint DEFAULT NULL ,  "top_nav_mode" tinyint DEFAULT NULL ,  "main_mode" tinyint DEFAULT NULL ,  "page_id" varchar(36)  DEFAULT NULL ,  "full_path" varchar(255)  DEFAULT NULL ,  "is_dev" tinyint DEFAULT '0' ,  PRIMARY KEY ("id") )  ;
-- ----------------------------
...
-- ----------------------------
CREATE TABLE  "sys_online_user" (  "id" varchar(32)  NOT NULL ,  "user_id" varchar(32)  DEFAULT NULL ,  "login_time" datetime ,  "login_ip" varchar(20)  DEFAULT NULL ,  "login_token" varchar(1024)  DEFAULT NULL ,  "expire_time" datetime ,  "when_created" datetime ,  "app_id" varchar(36)  DEFAULT NULL ,  PRIMARY KEY ("id") )  ;
-- ----------------------------
-- Table structure for sys_operate_log
-- ----------------------------
CREATE TABLE   "sys_operate_log" (  "id" varchar(32)  NOT NULL ,  "module" varchar(100)  DEFAULT NULL ,  "action" varchar(255)  DEFAULT NULL ,  "url" varchar(255)  DEFAULT NULL ,  "operate_time" datetime ,  "operator" varchar(32)  DEFAULT NULL ,  "ip" varchar(20)  DEFAULT NULL ,  "times" int DEFAULT NULL ,  "request_body" text  ,  "response_code" int DEFAULT NULL ,  "response_message" varchar(100)  DEFAULT NULL ,  "when_created" varchar(20)  DEFAULT NULL ,  "app_id" varchar(36)  DEFAULT NULL ,  PRIMARY KEY ("id") )  ;
-- ----------------------------
-- Table structure for sys_role_menu
-- ----------------------------
CREATE TABLE  "sys_role_menu" (  "id" varchar(32)  NOT NULL ,  "sys_menu_id" varchar(32)  NOT NULL ,  "sys_role_id" varchar(50)  NOT NULL ,  "who_created" varchar(32)  NOT NULL ,  "when_created" varchar(20)  NOT NULL ,  "app_id" varchar(36)  DEFAULT NULL ,  PRIMARY KEY ("id") )  ;
-- ----------------------------
-- Table structure for sys_task
-- ----------------------------
CREATE TABLE  "sys_task" (  "id" varchar(32)  NOT NULL ,  "name" varchar(100)  DEFAULT NULL ,  "cron" varchar(50)  DEFAULT NULL ,  "distributed" tinyint DEFAULT NULL ,  "application_id" varchar(32)  DEFAULT NULL ,  "task_type" tinyint DEFAULT '1' ,  "task_resource_id" varchar(36)  DEFAULT NULL ,  "class_name" varchar(255)  DEFAULT NULL ,  "enable" tinyint DEFAULT '1' ,  "last_execute_status" tinyint DEFAULT NULL ,  "last_execute_msg" text  ,  "last_execute_time" datetime ,  "last_execute_take" int DEFAULT NULL ,  "lock_status" tinyint DEFAULT '0' ,  "lock_for_most" int DEFAULT '30' ,  "lock_for_least" int DEFAULT '1' ,  "lock_for_time" datetime ,  "note" text  ,  "who_created" varchar(32)  DEFAULT NULL ,  "when_created" datetime ,  "who_modified" varchar(32)  DEFAULT NULL ,  "when_modified" datetime ,  "app_id" varchar(36)  DEFAULT NULL ,  PRIMARY KEY ("id") )  ;
-- ----------------------------
-- Table structure for sys_view_model
-- ----------------------------
CREATE TABLE  "sys_view_model" (  "id" varchar(36)  NOT NULL ,  "name" varchar(50)  DEFAULT NULL ,  "note" text  ,  "who_created" varchar(32)  DEFAULT NULL ,  "when_created" datetime ,  "who_modified" varchar(32)  DEFAULT NULL ,  "when_modified" datetime ,  "deleted" int DEFAULT '0' ,  "tag" varchar(100)  DEFAULT NULL ,  PRIMARY KEY ("id") )  ;
-- ----------------------------
-- Table structure for sys_view_model_field
-- ----------------------------
CREATE TABLE  "sys_view_model_field" (  "id" varchar(32)  NOT NULL ,  "view_model_id" varchar(32)  DEFAULT NULL ,  "field" varchar(50)  DEFAULT NULL ,  "label" varchar(50)  DEFAULT NULL ,  "type" varchar(20)  DEFAULT NULL ,  "format_type" varchar(20)  DEFAULT NULL ,  "format_pattern" varchar(50)  DEFAULT NULL ,  "default_text" varchar(50)  DEFAULT NULL ,  "who_created" varchar(32)  DEFAULT NULL ,  "when_created" datetime ,  "who_modified" varchar(32)  DEFAULT NULL ,  "when_modified" datetime ,  "hidden" int DEFAULT '0' ,  "order_num" int DEFAULT '0' )  ;
-- ----------------------------
-- Table structure for sys_view_model_flow
-- ----------------------------
CREATE TABLE  "sys_view_model_flow" (  "id" varchar(32)  NOT NULL,  "flow_id" varchar(36)  DEFAULT NULL ,  "view_model_id" varchar(32)  DEFAULT NULL ,  "who_created" varchar(32)  DEFAULT NULL ,  "when_created" datetime ,  "who_modified" varchar(32)  DEFAULT NULL ,  "when_modified" datetime ,  PRIMARY KEY ("id") )  ;
