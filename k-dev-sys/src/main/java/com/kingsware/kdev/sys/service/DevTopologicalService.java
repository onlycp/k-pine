 ...
 */
public interface DevTopologicalService extends BaseService {
     ...
     * @return      返回结果
     */
    DevTopologicalRet get(String id);

    /**
     * 新增
     * @param argv 新增
     */
     void add(DevTopologicalArgv argv);

    /**
     * 编辑
     * @param argv 编辑
     */
    void edit(DevTopologicalArgv argv);
     ...
     * @return 查询结果
     */
     PageDataRet<DevTopologicalRet> query(DevTopologicalQueryArgv argv);
