...
-- ----------------------------
CREATE TABLE IF NOT EXISTS`sys_unit` (  `id` varchar(36)  NOT NULL ,  `name` varchar(50)  NOT NULL ,  `parent_id` varchar(36)  DEFAULT NULL ,  `path` text  NOT NULL,  `leader` varchar(255)  DEFAULT NULL ,  `mobile` varchar(20)  DEFAULT NULL,  `email` varchar(50)  DEFAULT NULL,  `status` tinyint(4) NOT NULL DEFAULT '1' ,  `note` text ,  `order_num` int(10) DEFAULT '0' ,  `who_created` varchar(36)  NOT NULL ,  `when_created` varchar(20)  NOT NULL ,  `who_modified` varchar(36)  NOT NULL ,  `when_modified` varchar(20)  NOT NULL ,  `app_id` varchar(36)  DEFAULT NULL ,  PRIMARY KEY (`id`) ) ;
-- ----------------------------
-- Table structure for sys_user
-- ----------------------------
CREATE TABLE IF NOT EXISTS`sys_user` (  `id` varchar(36)  NOT NULL ,  `username` varchar(50)  NOT NULL ,  `password` varchar(256)  DEFAULT NULL,  `real_name` varchar(50)  NOT NULL ,  `mobile` varchar(20)  DEFAULT NULL ,  `email` varchar(50)  DEFAULT NULL ,  `sex` tinyint(4) DEFAULT NULL ,  `sys_unit_id` varchar(36)  DEFAULT NULL ,  `post` varchar(50)  DEFAULT NULL,  `status` tinyint(4) DEFAULT '1' ,  `note` text ,  `who_created` varchar(36)  DEFAULT NULL ,  `when_created` varchar(20)  DEFAULT NULL ,  `who_modified` varchar(36)  DEFAULT NULL ,  `when_modified` varchar(20)  DEFAULT NULL ,  `deleted` tinyint(4) DEFAULT '0' ,  `avatar` varchar(255)  DEFAULT NULL,  `app_id` varchar(36)  DEFAULT NULL ,  PRIMARY KEY (`id`) );
-- ----------------------------
-- Table structure for sys_role
-- ----------------------------
CREATE TABLE IF NOT EXISTS`sys_role` (  `id` varchar(36)  NOT NULL ,  `name` varchar(50)  NOT NULL ,  `code` varchar(50)  NOT NULL ,  `note` text ,  `status` tinyint(4) DEFAULT NULL ,  `who_created` varchar(36)  NOT NULL ,  `when_created` varchar(20)  NOT NULL ,  `who_modified` varchar(36)  NOT NULL ,  `when_modified` varchar(20)  NOT NULL ,  `app_id` varchar(36)  DEFAULT NULL ,  PRIMARY KEY (`id`)) ;
-- ----------------------------
-- Table structure for sys_user_role
-- ----------------------------
CREATE TABLE IF NOT EXISTS`sys_user_role` (  `id` varchar(36)  NOT NULL ,  `sys_user_id` varchar(36)  NOT NULL ,  `sys_role_id` varchar(36)  NOT NULL ,  `who_created` varchar(36)  NOT NULL ,  `when_created` varchar(20)  NOT NULL ,  `app_id` varchar(36)  DEFAULT NULL ,  PRIMARY KEY (`id`))  ;
-- ----------------------------
-- Table structure for dev_api
-- ----------------------------
CREATE TABLE IF NOT EXISTS`dev_api` (  `id` varchar(36)  NOT NULL DEFAULT '' ,  `api_name` varchar(50)  DEFAULT NULL ,  `application_id` varchar(36)  DEFAULT NULL ,  `api_url` varchar(128)  DEFAULT NULL ,  `api_note` text ,  `api_tags` varchar(128)  DEFAULT NULL ,  `api_method` varchar(36)  DEFAULT 'get' ,  `api_argv_type` int(4) DEFAULT NULL ,  `api_req_argv` text  ,  `api_rsp_argv` text  ,  `api_result_handler` varchar(128)  DEFAULT NULL ,  `who_created` varchar(36)  DEFAULT NULL ,  `when_created` varchar(20)  DEFAULT NULL ,  `who_modified` varchar(36)  DEFAULT NULL, `when_modified` varchar(20)  DEFAULT NULL ,  `api_flow_id` varchar(50)  DEFAULT NULL ,  `api_code` varchar(50)  DEFAULT NULL,  `call_type` int(4) DEFAULT NULL ,  `app_id` varchar(36)  DEFAULT NULL ,  PRIMARY KEY (`id`) ) ;
-- ----------------------------
...
-- ----------------------------
CREATE TABLE IF NOT EXISTS`dev_view_model` (  `id` varchar(36)  NOT NULL ,  `name` varchar(50)  DEFAULT NULL ,  `note` text  ,  `who_created` varchar(36)  DEFAULT NULL ,  `when_created` varchar(20) NULL DEFAULT NULL ,  `who_modified` varchar(36)  DEFAULT NULL ,  `when_modified` varchar(20) NULL DEFAULT NULL ,  `deleted` int(11) DEFAULT '0' ,  `tag` varchar(100)  DEFAULT NULL,  `app_id` varchar(36)  DEFAULT NULL ,  PRIMARY KEY (`id`) ) ;
-- ----------------------------
-- Table structure for dev_view_model_field
-- ----------------------------
CREATE TABLE IF NOT EXISTS`dev_view_model_field` (  `id` varchar(36)  NOT NULL ,  `view_model_id` varchar(36)  DEFAULT NULL ,  `field` varchar(50)  DEFAULT NULL ,  `label` varchar(50)  DEFAULT NULL ,  `type` varchar(20)  DEFAULT NULL ,  `format_type` varchar(20)  DEFAULT NULL,  `format_pattern` varchar(50)  DEFAULT NULL ,  `default_text` varchar(50)  DEFAULT NULL,  `who_created` varchar(36)  DEFAULT NULL ,  `when_created` varchar(20) NULL DEFAULT NULL ,  `who_modified` varchar(36)  DEFAULT NULL ,  `when_modified` varchar(20) NULL DEFAULT NULL ,  `hidden` int(11) DEFAULT '0' ,  `order_num` int(11) DEFAULT '0' ,  `app_id` varchar(36)  DEFAULT NULL ,  PRIMARY KEY (`id`)) ;
-- ----------------------------
-- Table structure for dev_view_model_flow
-- ----------------------------
CREATE TABLE IF NOT EXISTS`dev_view_model_flow` (  `id` varchar(36)  NOT NULL,  `flow_id` varchar(36)  DEFAULT NULL,  `view_model_id` varchar(36)  DEFAULT NULL ,  `who_created` varchar(36)  DEFAULT NULL ,  `when_created` varchar(20) NULL DEFAULT NULL ,  `who_modified` varchar(36)  DEFAULT NULL ,  `when_modified` varchar(20) NULL DEFAULT NULL ,  `app_id` varchar(36)  DEFAULT NULL ,  PRIMARY KEY (`id`) ) ;
-- ----------------------------
-- Table structure for sys_api
-- ----------------------------
CREATE TABLE IF NOT EXISTS`sys_api` (  `id` varchar(36)  NOT NULL DEFAULT '' ,  `api_name` varchar(50)  DEFAULT NULL ,  `api_url` varchar(128)  DEFAULT NULL ,  `api_note` text ,  `api_tags` varchar(128)  DEFAULT NULL ,  `api_method` varchar(36)  DEFAULT 'get' ,  `api_argv_type` int(4) DEFAULT NULL ,  `api_req_argv` text ,  `api_rsp_argv` text  ,  `api_result_handler` varchar(128)  DEFAULT NULL ,  `who_created` varchar(36)  DEFAULT NULL ,  `when_created` varchar(20)  DEFAULT NULL ,  `who_modified` varchar(36)  DEFAULT NULL ,  `when_modified` varchar(20)  DEFAULT NULL ,  `api_flow_id` varchar(50)  DEFAULT NULL ,  `api_code` varchar(50)  DEFAULT NULL ,  `call_type` int(4) DEFAULT NULL ,  `app_id` varchar(36)  DEFAULT NULL ,  PRIMARY KEY (`id`) ) ;
-- ----------------------------
-- ----------------------------
-- Table structure for sys_config
-- ----------------------------
CREATE TABLE IF NOT EXISTS`sys_config` (  `id` varchar(36)  NOT NULL ,  `name` varchar(255)  DEFAULT NULL ,  `code` varchar(255)  DEFAULT NULL ,  `value` varchar(255)  DEFAULT NULL ,  `is_sys` tinyint(4) DEFAULT NULL ,  `note` varchar(255)  DEFAULT NULL,  `who_created` varchar(36)  DEFAULT NULL ,  `when_created` varchar(20)  DEFAULT NULL ,  `who_modified` varchar(36)  DEFAULT NULL ,  `when_modified` varchar(20)  DEFAULT NULL ,  `value_type` tinyint(4) DEFAULT '0',  `app_id` varchar(36)  DEFAULT NULL ,  PRIMARY KEY (`id`)) ;
-- ----------------------------
-- Table structure for sys_data_access
-- ----------------------------
CREATE TABLE IF NOT EXISTS`sys_data_access` (  `id` varchar(36)  NOT NULL ,  `name` varchar(50)  DEFAULT NULL ,  `status` tinyint(4) DEFAULT NULL ,  `note` text ,  `who_created` varchar(36)  DEFAULT NULL ,  `when_created` varchar(20)  DEFAULT NULL ,  `who_modified` varchar(36)  DEFAULT NULL ,  `when_modified` varchar(20)  DEFAULT NULL ,  `app_id` varchar(36)  DEFAULT NULL ,  PRIMARY KEY (`id`) ) ;
-- ----------------------------
-- Table structure for sys_data_resource
-- ----------------------------
CREATE TABLE IF NOT EXISTS`sys_data_resource` (  `id` varchar(36)  NOT NULL ,  `name` varchar(50)  DEFAULT NULL ,  `table_name` varchar(50)  DEFAULT NULL ,  `label_field` varchar(50)  DEFAULT NULL ,  `value_field` varchar(50)  DEFAULT NULL ,  `query_sql` text  ,  `is_tree` tinyint(4) DEFAULT NULL ,  `is_only_leaf` tinyint(4) DEFAULT NULL ,  `status` tinyint(4) DEFAULT NULL ,  `who_created` varchar(36)  DEFAULT NULL ,  `when_created` varchar(20)  DEFAULT NULL ,  `who_modified` varchar(36)  DEFAULT NULL ,  `when_modified` varchar(20)  DEFAULT NULL ,  `extra_sql` text  ,  `app_id` varchar(36)  DEFAULT NULL ,  PRIMARY KEY (`id`) ) ;
-- ----------------------------
-- Table structure for sys_data_access_resource
-- ----------------------------
CREATE TABLE IF NOT EXISTS`sys_data_access_resource` (  `id` varchar(36)  NOT NULL ,  `data_id` varchar(36)  DEFAULT NULL ,  `access_id` varchar(36)  DEFAULT NULL ,  `table_name` varchar(50)  DEFAULT NULL,  `who_created` varchar(36)  DEFAULT NULL ,  `when_created` varchar(20)  DEFAULT NULL ,  `app_id` varchar(36)  DEFAULT NULL ,  PRIMARY KEY (`id`) ) ;
-- ----------------------------
-- Table structure for sys_data_access_user
-- ----------------------------
CREATE TABLE IF NOT EXISTS`sys_data_access_user` (  `id` varchar(36)  NOT NULL ,  `sys_user_id` varchar(36)  DEFAULT NULL ,  `sys_data_access_id` varchar(50)  DEFAULT NULL ,  `who_created` varchar(36)  DEFAULT NULL ,  `when_created` varchar(20)  DEFAULT NULL ,  `app_id` varchar(36)  DEFAULT NULL ,  PRIMARY KEY (`id`) );

-- ----------------------------
-- Table structure for sys_dict
-- ----------------------------
CREATE TABLE IF NOT EXISTS`sys_dict` (  `id` varchar(36)  NOT NULL ,  `name` varchar(50)  DEFAULT NULL ,  `code` varchar(50)  DEFAULT NULL ,  `note` text ,  `who_created` varchar(36)  DEFAULT NULL ,  `when_created` varchar(20)  DEFAULT NULL ,  `who_modified` varchar(36)  DEFAULT NULL ,  `when_modified` varchar(20)  DEFAULT NULL ,  `app_id` varchar(36)  DEFAULT NULL ,  PRIMARY KEY (`id`)  ) ;
-- ----------------------------
-- Table structure for sys_dict_item
-- ----------------------------
CREATE TABLE IF NOT EXISTS`sys_dict_item` (  `id` varchar(36)  NOT NULL ,  `name` varchar(50)  DEFAULT NULL ,  `group_name` varchar(50)  DEFAULT NULL ,  `sys_dict_id` varchar(36)  DEFAULT NULL ,  `code` varchar(50)  DEFAULT NULL ,  `value` varchar(20)  DEFAULT NULL ,  `order_num` int(8) DEFAULT NULL,  `note` text ,  `who_created` varchar(36)  DEFAULT NULL ,  `when_created` varchar(20)  DEFAULT NULL ,  `who_modified` varchar(36)  DEFAULT NULL ,  `when_modified` varchar(20)  DEFAULT NULL ,  `app_id` varchar(36)  DEFAULT NULL ,  PRIMARY KEY (`id`)  ) ;
-- ----------------------------
-- Table structure for sys_file
-- ----------------------------
CREATE TABLE IF NOT EXISTS`sys_file` (  `id` varchar(36)  NOT NULL ,  `file_name` varchar(100)  DEFAULT NULL ,  `file_original_name` varchar(100)  DEFAULT NULL ,  `file_size` int(11) DEFAULT NULL,  `file_ext` text  ,  `file_md5` varchar(40)  DEFAULT NULL ,  `file_from` varchar(50)  DEFAULT NULL ,  `save_type` int(4) DEFAULT NULL ,`file_path` varchar(100)  DEFAULT NULL ,  `file_content` longtext ,  `who_created` varchar(36)  DEFAULT NULL ,  `when_created` varchar(20)  DEFAULT NULL ,  `who_modified` varchar(36)  DEFAULT NULL ,  `when_modified` varchar(20)  DEFAULT NULL ,  `app_id` varchar(36)  DEFAULT NULL ,  PRIMARY KEY (`id`) );
-- ----------------------------
-- Table structure for sys_logic_flow
-- ----------------------------
CREATE TABLE IF NOT EXISTS`sys_logic_flow` (  `id` varchar(36)  NOT NULL ,  `name` varchar(255)  DEFAULT NULL ,  `flow_id` varchar(36)  DEFAULT NULL ,  `application_id` varchar(36)  DEFAULT NULL ,  `tags` varchar(255)  DEFAULT NULL ,  `in_argv` text  ,  `out_argv` text ,  `sub_flow_ids` text,    `note` varchar(255)  DEFAULT NULL,  `who_created` varchar(36)  DEFAULT NULL ,  `when_created` varchar(20) NULL DEFAULT NULL ,  `who_modified` varchar(36)  DEFAULT NULL ,  `when_modified` varchar(20) NULL DEFAULT NULL ,  `app_id` varchar(36)  DEFAULT NULL ,  PRIMARY KEY (`id`) ) ;
-- ----------------------------
-- Table structure for sys_login_log
-- ----------------------------
CREATE TABLE IF NOT EXISTS`sys_login_log` (  `id` varchar(36)  NOT NULL ,  `operate_time` varchar(20) DEFAULT NULL ,  `operator` varchar(36)  DEFAULT NULL,  `ip` varchar(20)  DEFAULT NULL ,  `times` int(10) DEFAULT NULL ,  `response_code` int(11) DEFAULT NULL ,  `response_message` varchar(100)  DEFAULT NULL ,  `when_created` varchar(20)  DEFAULT NULL);
-- ----------------------------
-- Table structure for sys_menu
-- ----------------------------
CREATE TABLE IF NOT EXISTS`sys_menu` (  `id` varchar(36)  NOT NULL ,  `name` varchar(50)  NOT NULL ,  `parent_id` varchar(36)  DEFAULT NULL ,  `icon` varchar(50)  DEFAULT NULL,  `code` varchar(50)  DEFAULT NULL ,  `router_path` varchar(255)  DEFAULT NULL ,  `component_path` varchar(255)  DEFAULT NULL ,  `is_hidden` tinyint(4) NOT NULL DEFAULT '0' ,  `menu_type` char(1)  NOT NULL DEFAULT '0' ,  `api_codes` varchar(255)  DEFAULT NULL ,  `open_mode` tinyint(4) NOT NULL ,  `keep_alive` tinyint(4) DEFAULT NULL ,  `path` text  NOT NULL ,  `order_num` int(4) NOT NULL DEFAULT '0',  `status` tinyint(4) NOT NULL DEFAULT '1' ,  `who_created` varchar(36)  NOT NULL ,  `when_created` varchar(20)  NOT NULL ,  `who_modified` varchar(36)  NOT NULL ,  `when_modified` varchar(20)  NOT NULL ,  `app_id` varchar(36)  DEFAULT NULL,  `data_type` tinyint(2) DEFAULT NULL,  `theme` varchar(50)  DEFAULT NULL ,  `page_type` tinyint(2) DEFAULT NULL,  `sidebar_nav_mode` tinyint(2) DEFAULT NULL ,  `top_nav_mode` tinyint(2) DEFAULT NULL ,  `main_mode` tinyint(2) DEFAULT NULL ,  `page_id` varchar(36)  DEFAULT NULL ,  `full_path` varchar(255)  DEFAULT NULL ,  `is_dev` tinyint(1) DEFAULT '0',  PRIMARY KEY (`id`) );
-- ----------------------------
...
-- ----------------------------
CREATE TABLE IF NOT EXISTS`sys_online_user` (  `id` varchar(36)  NOT NULL ,  `user_id` varchar(36)  DEFAULT NULL ,  `login_time` varchar(20) NULL DEFAULT NULL ,  `login_ip` varchar(20)  DEFAULT NULL,  `login_token` varchar(1024)  DEFAULT NULL ,  `expire_time` varchar(20) NULL DEFAULT NULL ,  `when_created` varchar(20) NULL DEFAULT NULL ,  `app_id` varchar(36)  DEFAULT NULL ,  PRIMARY KEY (`id`) ) ;
-- ----------------------------
-- Table structure for sys_operate_log
-- ----------------------------
CREATE TABLE IF NOT EXISTS `sys_operate_log` (  `id` varchar(36)  NOT NULL ,  `module` varchar(100)  DEFAULT NULL ,  `action` varchar(255)  DEFAULT NULL ,  `url` varchar(255)  DEFAULT NULL ,  `operate_time` varchar(20) DEFAULT NULL ,  `operator` varchar(36)  DEFAULT NULL,  `ip` varchar(20)  DEFAULT NULL ,  `times` int(10) DEFAULT NULL ,  `request_body` text  ,  `response_code` int(11) DEFAULT NULL ,  `response_message` varchar(100)  DEFAULT NULL ,  `when_created` varchar(20)  DEFAULT NULL ,  `app_id` varchar(36)  DEFAULT NULL ,  PRIMARY KEY (`id`));
-- ----------------------------
-- Table structure for sys_role_menu
-- ----------------------------
CREATE TABLE IF NOT EXISTS`sys_role_menu` (  `id` varchar(36)  NOT NULL ,  `sys_menu_id` varchar(36)  NOT NULL ,  `sys_role_id` varchar(50)  NOT NULL ,  `who_created` varchar(36)  NOT NULL ,  `when_created` varchar(20)  NOT NULL ,  `app_id` varchar(36)  DEFAULT NULL ,  PRIMARY KEY (`id`) ) ;
-- ----------------------------
-- Table structure for sys_task
-- ----------------------------
CREATE TABLE IF NOT EXISTS`sys_task` (  `id` varchar(36)  NOT NULL ,  `name` varchar(100)  DEFAULT NULL  ,  `cron` varchar(50)  DEFAULT NULL ,  `distributed` tinyint(4) DEFAULT NULL ,  `application_id` varchar(36)  DEFAULT NULL ,  `task_type` tinyint(4) DEFAULT '1' ,  `task_resource_id` varchar(36)  DEFAULT NULL ,  `class_name` varchar(255)  DEFAULT NULL ,  `enable` tinyint(4) DEFAULT '1' ,  `last_execute_status` tinyint(4) DEFAULT NULL ,  `last_execute_msg` text ,  `last_execute_time` varchar(20) NULL DEFAULT NULL,  `last_execute_take` int(11) DEFAULT NULL ,  `lock_status` tinyint(4) DEFAULT '0' ,  `lock_for_most` int(8) DEFAULT '30',  `lock_for_least` int(8) DEFAULT '1' ,  `lock_for_time` varchar(20) NULL DEFAULT NULL ,  `note` text ,  `who_created` varchar(36)  DEFAULT NULL ,  `when_created` varchar(20) NULL DEFAULT NULL ,  `who_modified` varchar(36)  DEFAULT NULL ,  `when_modified` varchar(20) NULL DEFAULT NULL ,  `app_id` varchar(36)  DEFAULT NULL ,  PRIMARY KEY (`id`) ) ;
-- ----------------------------
-- Table structure for sys_view_model
-- ----------------------------
CREATE TABLE IF NOT EXISTS`sys_view_model` (  `id` varchar(36)  NOT NULL ,  `name` varchar(50)  DEFAULT NULL ,  `note` text  ,  `who_created` varchar(36)  DEFAULT NULL ,  `when_created` varchar(20) NULL DEFAULT NULL ,  `who_modified` varchar(36)  DEFAULT NULL ,  `when_modified` varchar(20) NULL DEFAULT NULL ,  `deleted` int(11) DEFAULT '0' ,  `tag` varchar(100)  DEFAULT NULL ,  PRIMARY KEY (`id`)) ;
-- ----------------------------
-- Table structure for sys_view_model_field
-- ----------------------------
CREATE TABLE IF NOT EXISTS`sys_view_model_field` (  `id` varchar(36)  NOT NULL ,  `view_model_id` varchar(36)  DEFAULT NULL ,  `field` varchar(50)  DEFAULT NULL ,  `label` varchar(50)  DEFAULT NULL ,  `type` varchar(20)  DEFAULT NULL ,  `format_type` varchar(20)  DEFAULT NULL ,  `format_pattern` varchar(50)  DEFAULT NULL ,  `default_text` varchar(50)  DEFAULT NULL ,  `who_created` varchar(36)  DEFAULT NULL ,  `when_created` varchar(20) NULL DEFAULT NULL ,  `who_modified` varchar(36)  DEFAULT NULL ,  `when_modified` varchar(20) NULL DEFAULT NULL ,  `hidden` int(11) DEFAULT '0' ,  `order_num` int(11) DEFAULT '0' );
-- ----------------------------
-- Table structure for sys_view_model_flow
-- ----------------------------
CREATE TABLE IF NOT EXISTS`sys_view_model_flow` (  `id` varchar(36)  NOT NULL,  `flow_id` varchar(36)  DEFAULT NULL,  `view_model_id` varchar(36)  DEFAULT NULL ,  `who_created` varchar(36)  DEFAULT NULL ,  `when_created` varchar(20) NULL DEFAULT NULL ,  `who_modified` varchar(36)  DEFAULT NULL ,  `when_modified` varchar(20) NULL DEFAULT NULL ,  PRIMARY KEY (`id`)) ;
