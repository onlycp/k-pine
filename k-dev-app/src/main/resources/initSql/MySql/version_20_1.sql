...
alter table `cm_customer_info` add column `when_created` timestamp COMMENT '创建时间';
...
alter table `ext_plugin_interface` add column `create_time` timestamp DEFAULT CURRENT_TIMESTAMP COMMENT '';
...
alter table `ext_plugin_interface` add column `update_time` timestamp DEFAULT CURRENT_TIMESTAMP COMMENT '';
...
alter table `ext_plugin_tree` add column `check_time` timestamp DEFAULT NULL COMMENT '插件检测时间';
alter table `ext_plugin_tree` add column `clazz_name` varchar(255) DEFAULT NULL COMMENT '调用插件方法名';
alter table `ext_plugin_tree` add column `create_time` timestamp DEFAULT CURRENT_TIMESTAMP COMMENT '';
...
alter table `ext_plugin_tree` add column `update_time` timestamp DEFAULT CURRENT_TIMESTAMP COMMENT '';
...
alter table `sys_auto_serial` add column `create_time` timestamp DEFAULT CURRENT_TIMESTAMP COMMENT '';
...
alter table `sys_auto_serial` add column `update_time` timestamp DEFAULT CURRENT_TIMESTAMP COMMENT '';
