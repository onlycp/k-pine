...
CREATE TABLE IF NOT EXISTS `cm_app_role`  (`id` varchar(36) NOT NULL, PRIMARY KEY (`id`));
...
CREATE TABLE IF NOT EXISTS `cm_customer_app_menu`  (`id` varchar(36)  NOT NULL, PRIMARY KEY (`id`) ) ;
...
CREATE TABLE IF NOT EXISTS `cm_customer_db`  (`id` varchar(36) NOT NULL, PRIMARY KEY (`id`) );
...
CREATE TABLE IF NOT EXISTS `cm_customer_info`  (`id` varchar(36) NOT NULL, PRIMARY KEY (`id`));
...
CREATE TABLE IF NOT EXISTS `cm_customer_user`  (`id` varchar(36) NOT NULL, PRIMARY KEY (`id`));
...
CREATE TABLE IF NOT EXISTS `dev_api`  (`id` varchar(36) NOT NULL, PRIMARY KEY (`id`));
...
CREATE TABLE IF NOT EXISTS `dev_application`  (`id` varchar(36) NOT NULL, PRIMARY KEY (`id`));
...
CREATE TABLE IF NOT EXISTS `dev_application_version_history`  (`id` varchar(36) NOT NULL, PRIMARY KEY (`id`));
...
CREATE TABLE IF NOT EXISTS `dev_document`  (`id` varchar(36) NOT NULL, PRIMARY KEY (`id`));
...
CREATE TABLE IF NOT EXISTS `dev_module`  (`id` varchar(36) NOT NULL, PRIMARY KEY (`id`));
...
CREATE TABLE IF NOT EXISTS `dev_ota_channel`  (`id` varchar(36) NOT NULL, PRIMARY KEY (`id`));
...
CREATE TABLE IF NOT EXISTS `dev_page`  (`id` varchar(36) NOT NULL, PRIMARY KEY (`id`));
...
CREATE TABLE IF NOT EXISTS `dev_page_history`  (`id` varchar(36) NOT NULL, PRIMARY KEY (`id`));
...
CREATE TABLE IF NOT EXISTS `dev_pine_plugin`  (`id` varchar(36) NOT NULL, PRIMARY KEY (`id`));
...
CREATE TABLE IF NOT EXISTS `dev_power_link`  (`id` varchar(36) NOT NULL, PRIMARY KEY (`id`));
...
CREATE TABLE IF NOT EXISTS `dev_power_tree`  (`id` varchar(36) NOT NULL, PRIMARY KEY (`id`));
...
CREATE TABLE IF NOT EXISTS `dev_sql_run`  (`id` varchar(36) NOT NULL, PRIMARY KEY (`id`));
...
CREATE TABLE IF NOT EXISTS `dev_sql_script`  (`id` varchar(36) NOT NULL, PRIMARY KEY (`id`));
...
CREATE TABLE IF NOT EXISTS `dev_team`  (`id` varchar(36) NOT NULL, PRIMARY KEY (`id`));
...
CREATE TABLE IF NOT EXISTS `dev_team_app`  (`id` varchar(36) NOT NULL, PRIMARY KEY (`id`));
...
CREATE TABLE IF NOT EXISTS `dev_team_member`  (`id` varchar(36) NOT NULL, PRIMARY KEY (`id`));
...
CREATE TABLE IF NOT EXISTS `dev_topological`  (`id` varchar(36) NOT NULL, PRIMARY KEY (`id`));
...
CREATE TABLE IF NOT EXISTS `dev_view_model`  (`id` varchar(36) NOT NULL, PRIMARY KEY (`id`));
...
CREATE TABLE IF NOT EXISTS `dev_view_model_field`  (`id` varchar(36) NOT NULL, PRIMARY KEY (`id`));
...
CREATE TABLE IF NOT EXISTS `dev_view_model_flow`  (`id` varchar(36) NOT NULL, PRIMARY KEY (`id`));
...
CREATE TABLE IF NOT EXISTS `ext_plugin_interface`  (`id` varchar(36) NOT NULL, PRIMARY KEY (`id`));
alter table `ext_plugin_interface` add column `content` text DEFAULT NULL COMMENT '接口使用说明Demo';
alter table `ext_plugin_interface` add column `create_time` varchar(30) COMMENT '';
...
alter table `ext_plugin_interface` add column `update_time` varchar(30) COMMENT '';
alter table `ext_plugin_interface` add column `update_user` varchar(255) DEFAULT NULL COMMENT '';
CREATE TABLE IF NOT EXISTS `ext_plugin_tree`  (`id` varchar(36) NOT NULL, PRIMARY KEY (`id`));
alter table `ext_plugin_tree` add column `check_time` varchar(30) COMMENT '插件检测时间';
alter table `ext_plugin_tree` add column `clazz_name` varchar(255) DEFAULT NULL COMMENT '调用插件方法名';
alter table `ext_plugin_tree` add column `create_time` varchar(30) COMMENT '';
...
alter table `ext_plugin_tree` add column `update_time` varchar(30) COMMENT '';
alter table `ext_plugin_tree` add column `update_user` varchar(255) DEFAULT NULL COMMENT '';
CREATE TABLE IF NOT EXISTS `kfaas_lib`  (`id` varchar(36) NOT NULL, PRIMARY KEY (`id`));
...
CREATE TABLE IF NOT EXISTS `number_regulation`  (`id` varchar(36) NOT NULL, PRIMARY KEY (`id`));
...
CREATE TABLE IF NOT EXISTS `number_serial`  (`id` varchar(36) NOT NULL, PRIMARY KEY (`id`));
...
CREATE TABLE IF NOT EXISTS `open_account`  (`id` varchar(36) NOT NULL, PRIMARY KEY (`id`));
...
alter table `open_account` add column `valid_date` varchar(30) DEFAULT NULL COMMENT '生效日期';
...
CREATE TABLE IF NOT EXISTS `open_account_api`  (`id` varchar(36) NOT NULL, PRIMARY KEY (`id`));
...
CREATE TABLE IF NOT EXISTS `open_api_log`  (`id` varchar(36) NOT NULL, PRIMARY KEY (`id`));
...
CREATE TABLE IF NOT EXISTS `rep_app`  (`id` varchar(36) NOT NULL, PRIMARY KEY (`id`));
...
CREATE TABLE IF NOT EXISTS `rep_dataset`  (`id` varchar(36) NOT NULL, PRIMARY KEY (`id`));
...
CREATE TABLE IF NOT EXISTS `sys_api`  (`id` varchar(36) NOT NULL, PRIMARY KEY (`id`));
...
CREATE TABLE IF NOT EXISTS `sys_auto_serial`  (`id` varchar(36) NOT NULL, PRIMARY KEY (`id`));
...
CREATE TABLE IF NOT EXISTS `sys_base`  (`id` varchar(36) NOT NULL, PRIMARY KEY (`id`));
...
CREATE TABLE IF NOT EXISTS `sys_config`  (`id` varchar(36) NOT NULL, PRIMARY KEY (`id`));
...
CREATE TABLE IF NOT EXISTS `sys_data_access`  (`id` varchar(36) NOT NULL, PRIMARY KEY (`id`));
...
CREATE TABLE IF NOT EXISTS `sys_data_access_resource`  (`id` varchar(36) NOT NULL, PRIMARY KEY (`id`));
...
CREATE TABLE IF NOT EXISTS `sys_data_access_user`  (`id` varchar(36) NOT NULL, PRIMARY KEY (`id`));
...
CREATE TABLE IF NOT EXISTS `sys_data_resource`  (`id` varchar(36) NOT NULL, PRIMARY KEY (`id`));
...
CREATE TABLE IF NOT EXISTS `sys_dict`  (`id` varchar(36) NOT NULL, PRIMARY KEY (`id`));
...
CREATE TABLE IF NOT EXISTS `sys_dict_item`  (`id` varchar(36) NOT NULL, PRIMARY KEY (`id`));
...
CREATE TABLE IF NOT EXISTS `sys_excel`  (`id` varchar(36) NOT NULL, PRIMARY KEY (`id`));
...
CREATE TABLE IF NOT EXISTS `sys_file`  (`id` varchar(36) NOT NULL, PRIMARY KEY (`id`));
...
CREATE TABLE IF NOT EXISTS `sys_hint_select`  (`id` varchar(36) NOT NULL, PRIMARY KEY (`id`));
...
CREATE TABLE IF NOT EXISTS `sys_i18n`  (`id` varchar(36) NOT NULL, PRIMARY KEY (`id`));
...
CREATE TABLE IF NOT EXISTS `sys_logic_flow`  (`id` varchar(36) NOT NULL, PRIMARY KEY (`id`));
...
CREATE TABLE IF NOT EXISTS `sys_logic_history`  (`id` varchar(36) NOT NULL, PRIMARY KEY (`id`));
...
CREATE TABLE IF NOT EXISTS `sys_logic_template`  (`id` varchar(36) NOT NULL, PRIMARY KEY (`id`));
...
CREATE TABLE IF NOT EXISTS `sys_login_log`  (`id` varchar(36) NOT NULL, PRIMARY KEY (`id`));
...
CREATE TABLE IF NOT EXISTS `sys_menu`  (`id` varchar(36) NOT NULL, PRIMARY KEY (`id`));
...
CREATE TABLE IF NOT EXISTS `sys_mq_channel`  (`id` varchar(36) NOT NULL, PRIMARY KEY (`id`));
...
CREATE TABLE IF NOT EXISTS `sys_notice`  (`id` varchar(36) NOT NULL, PRIMARY KEY (`id`));
...
CREATE TABLE IF NOT EXISTS `sys_notice_record`  (`id` varchar(36) NOT NULL, PRIMARY KEY (`id`));
...
CREATE TABLE IF NOT EXISTS `sys_online_user`  (`id` varchar(36) NOT NULL, PRIMARY KEY (`id`));
...
CREATE TABLE IF NOT EXISTS `sys_operate_log`  (`id` varchar(36) NOT NULL, PRIMARY KEY (`id`));
...
CREATE TABLE IF NOT EXISTS `sys_role`  (`id` varchar(36) NOT NULL, PRIMARY KEY (`id`));
...
CREATE TABLE IF NOT EXISTS `sys_role_menu`  (`id` varchar(36) NOT NULL, PRIMARY KEY (`id`));
...
CREATE TABLE IF NOT EXISTS `sys_task`  (`id` varchar(36) NOT NULL, PRIMARY KEY (`id`));
...
CREATE TABLE IF NOT EXISTS `sys_unit`  (`id` varchar(36) NOT NULL, PRIMARY KEY (`id`));
...
CREATE TABLE IF NOT EXISTS `sys_user`  (`id` varchar(36) NOT NULL, PRIMARY KEY (`id`));
...
CREATE TABLE IF NOT EXISTS `sys_user_role`  (`id` varchar(36) NOT NULL, PRIMARY KEY (`id`));
...
CREATE TABLE IF NOT EXISTS `sys_view_model`  (`id` varchar(36) NOT NULL, PRIMARY KEY (`id`));
...
CREATE TABLE IF NOT EXISTS `sys_view_model_field`  (`id` varchar(36) NOT NULL, PRIMARY KEY (`id`));
...
CREATE TABLE IF NOT EXISTS `sys_view_model_flow`  (`id` varchar(36) NOT NULL, PRIMARY KEY (`id`));
...
CREATE TABLE IF NOT EXISTS `wf_demo_leave`  (`id` varchar(36) NOT NULL, PRIMARY KEY (`id`));
...
CREATE TABLE IF NOT EXISTS `wf_ext_category`  (`id` varchar(36) NOT NULL, PRIMARY KEY (`id`));
...
CREATE TABLE IF NOT EXISTS `wf_ext_comment`  (`id` varchar(36) NOT NULL, PRIMARY KEY (`id`));
...
CREATE TABLE IF NOT EXISTS `wf_ext_node_attribute`  (`id` varchar(36) NOT NULL, PRIMARY KEY (`id`));
...
CREATE TABLE IF NOT EXISTS `wf_ext_procdef`  (`id` varchar(36) NOT NULL, PRIMARY KEY (`id`));
...
CREATE TABLE IF NOT EXISTS `wf_ext_procinst`  (`id` varchar(36) NOT NULL, PRIMARY KEY (`id`));
