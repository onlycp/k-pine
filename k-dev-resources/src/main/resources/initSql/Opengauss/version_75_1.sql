CREATE TABLE sys_task_history(
                                 ...
                                 execute_take INTEGER,
                                 execute_begin_time VARCHAR(20),
...
COMMENT ON COLUMN sys_task_history.request_body IS '请求体内容';
COMMENT ON COLUMN sys_task_history.response_body IS '响应体内容';
