...
public class JdbcUrlUtils {
    ...
    public static void main(String[] argv) {
        String jdbcUrl = "jdbc:postgresql://192.168.2.89:5432/k-pine?useUnicode=true&characterEncoding=UTF-8&reWriteBatchedInserts=true";
        JdbcUrl jdbcUrl1 = parseUrl(jdbcUrl);
