...
public class SM4 {
    ...
    public byte[] sm4_crypt_ecb(SM4Context ctx, byte[] input) throws RuntimeException, IOException {
        if (input == null) {
    ...
    public byte[] sm4_crypt_cbc(SM4Context ctx, byte[] iv, byte[] input) throws RuntimeException, IOException {
