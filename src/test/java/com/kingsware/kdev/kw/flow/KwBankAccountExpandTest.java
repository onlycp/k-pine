...
class KwBankAccountExpandTest extends BaseFlowTest{
    ...
    /** 模块名称 **/
    private String moduleName = "项目扩展信息";
    /** 模块 **/
    private String tableName = "kw_bank_account_expand";
    ...
    void registerApis() {
        // 获取所有的接口
        List<SysApiArgv> argvs = ApiUtils.scanApis(KwBankAccountExpandController.class);
        // 增加系统
...
//            }
    ...
    void get() {
        ...
        FlowDefinition flowDefinition = FlowDefinition
                ...
                .start(flowName)
                // 成功支线
                .toSql("查询详细信息", "MySql2", "select * from kw_bank_account_expand where  id=#{id}", "")
                .toEnd("");
    ...
    void add() {
        ...
        String insertSql = FileUtils.readFileText(ResourceUtils.getFile("classpath:flow/kwBankAccountExpandAdd.html"));        // 创建实例
        FlowDefinition flowDefinition = FlowDefinition
                // 启动
                .start("版本管理-新增")
                //
    ...
    void edit() {
        ...
        String updateSql = FileUtils.readFileText(ResourceUtils.getFile("classpath:flow/kwBankAccountExpandEdit.html"));        // 创建实例
        // 创建实例
        FlowDefinition flowDefinition = FlowDefinition
                // 启动
                .start(flowName)
    ...
    void delete() {
        ...
        FlowDefinition flowDefinition = FlowDefinition
                ...
                .start(flowName)
                // 成功支线
                .toSql("删除", "MySql2", "delete from kw_bank_account_expand where id in (#{ids})")
                .toEnd("");
